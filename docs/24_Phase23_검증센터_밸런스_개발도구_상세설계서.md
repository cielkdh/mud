...
P23은 Property/Fuzz/Monte Carlo/Long World의 최초 발견 시점이 아니다. P2 RNG·시간, P3 Save/Recovery, P6 전투, P8 던전, P12 강화, P14 경제, P17 장기 월드는 각 소유 Phase Gate에서 먼저 검증한다. P23은 그 증거와 실패 seed를 공통 runner로 통합하고 shrink/repro·cross-domain 회귀·승인을 담당한다.
