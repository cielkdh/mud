...
| C18 자산/콘텐츠 | M/W 각 5,000장의 200×200 opaque sRGB PNG 또는 WebP 고정 풀(전체 동일 형식), install-time `portraits_v1` asset pack, Full 활성 행의 미정 효과·깨진 참조·배포권 미확인 0건 | 실제 파일·manifest·라이선스·decode·중복·용량 검사: `NOT_RUN` |
...
| [02 월드명령_시간_예약_RNG](03_Phase2_월드명령_시간_예약_RNG_상세설계서.md) | 단일 월드 작성자와 현실시간에 독립적인 이벤트 경계 진행을 구현한다. | P0 | 5 | 26 | 32 | DONE / QA PASS (Gate 필수 29 PASS; 이관 3 NOT_RUN) |
